...
public class ateroidescontrolet : MonoBehaviour
{
    public float speed_min;
    public float speed_max;

    Rigidbody2D rb;
    public Asteroids_manager manager;
    ...
    public void Muerte()
    {
        if(transform.localScale.x > 0.25)
        {
            ...
            temp1.GetComponent<ateroidescontrolet>().manager = manager;
            ...
            temp2.GetComponent<ateroidescontrolet>().manager = manager;
